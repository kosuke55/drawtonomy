...
editor through `postMessage`. The SDK gives you a typed client; the
dev-server gives you a local editor to develop against.

This page is a quick orientation. The full guide, including the
manifest schema, capabilities list, and message protocol, is in the
public repo:
...
- [`exporter-playground`](https://github.com/kosuke55/drawtonomy/tree/main/extensions/exporter-playground) — exercise the exporter with a live canvas.
...
- [Extension architecture](/explanation/extension-architecture/) — why
  iframes, why postMessage.
- [`@drawtonomy/sdk` overview](/reference/sdk/) — the package and its
  modules.
